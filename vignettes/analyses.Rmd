...
ecology.lat.model <- procD.pgls(coords ~ Csize + 
                              abslatitude + 
                              microhabitat + 
                              activity_time + 
                              foraging_mode, 
...
fm.micro.hab.model <- procD.pgls(coords ~ Csize +
                              microhabitat + 
                              foraging_mode, 
                            phy = lzrd_tree, SS.type = "III", data = wb.gdf, print.progress = F)

fm.hab.mod.model <- procD.pgls(coords ~ Csize +
                              habitat_modes + 
                              foraging_mode, 
                            phy = lzrd_tree, SS.type = "III", data = wb.gdf, print.progress = F)
...
#fm.hab.model had the lowest AIC, so we will select that model for summary


summary(fm.micro.hab.model)
...
ecology.lat.model <- procD.pgls(Csize ~ 
                              abslatitude + 
                              microhabitat + 
                              activity_time + 
                              foraging_mode, 
...
fm.micro.hab.model <- procD.pgls(Csize ~
                              microhabitat + 
                              foraging_mode, 
                            phy = lzrd_tree, SS.type = "III", data = wb.gdf, print.progress = F)

fm.hab.mod.model <- procD.pgls(Csize ~
                              habitat_modes + 
                              foraging_mode, 
                            phy = lzrd_tree, SS.type = "III", data = wb.gdf, print.progress = F)
